...
settings = Settings(
    ...
    authz_enabled=os.getenv("WG_AUTHZ_ENABLED", "false").lower() == "true",
    authz_fail_closed=os.getenv("WG_AUTHZ_FAIL_CLOSED", "false").lower() == "true",
    authz_default_allow=os.getenv("WG_AUTHZ_DEFAULT_ALLOW", "true").lower() == "true",
