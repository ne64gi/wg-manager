const JA_TRANSLATIONS: Record<string, string> = {
  ...
  "groups.scope": "スコープ",
  "groups.scope_single_site": "single_site",
  "groups.scope_multi_site": "multi_site",
  "groups.scope_admin": "admin",
  ...
  "groups.create_active_hint": "このグループを有効な状態で作成します。",
  "groups.edit_active_hint": "無効にすると、このグループ経由の新しい利用が止まります。",
  ...
  "groups.delete_confirm_prefix": "グループを削除しますか: ",
  ...
  "users.delete_confirm_prefix": "ユーザーを削除しますか: ",
  ...
  "settings.endpoint_heading": "公開エンドポイント設定",
