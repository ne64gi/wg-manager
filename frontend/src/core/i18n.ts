const JA_TRANSLATIONS: Record<string, string> = {
  ...
  "network.subtitle": "現在の Group -> User -> Peer 構成を、後でより本格的なレンダラーへ差し替えやすい 3D 風シーンとして表示します。",
  "network.scene": "3D 構成シーン",
  "network.groups": "グループ",
  "network.users": "ユーザー",
  "network.online_peers": "オンラインピア",
  "network.hidden_peers": "未表示 / 非公開ピア",
  "network.all_groups": "すべてのグループ",
  "network.layout_constellation": "コンステレーション",
  "network.layout_stacked": "スタック",
  "network.rotation_on": "自動回転オン",
  "network.rotation_off": "自動回転オフ",
  "network.no_data": "表示できるネットワークノードがまだありません。",
  "network.no_data_hint": "グループ、ユーザー、ピアを作成すると、このマップに反映されます。",
  "network.loading": "構成を読み込み中...",
  "network.legend": "凡例",
  "network.legend_group": "ネットワーク面と割当境界です。",
  "network.legend_user": "利用者単位のハブです。",
  "network.legend_peer": "各ユーザーにぶら下がる端末ノードです。",
