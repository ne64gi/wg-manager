const JA_TRANSLATIONS: Record<string, string> = {
  ...
  "auth.profile_title": "自分のプロフィール",
  "auth.name": "名前",
  "auth.email": "メールアドレス",
  "auth.timezone": "タイムゾーン",
  "auth.save_profile": "プロフィールを保存",
  "auth.profile_updated": "プロフィールを更新しました。",
  "auth.profile_update_failed": "プロフィールの更新に失敗しました。",
  ...
  "settings.refresh_heading": "監視と更新",
  ...
  "apply_preview.title": "サーバー設定の変更内容を確認",
  "apply_preview.subtitle": "適用前に、現在のサーバー設定と生成候補の差分を確認できます。",
  "apply_preview.load_failed": "設定プレビューの読み込みに失敗しました。",
  "apply_preview.current_lines": "現在の行数",
  "apply_preview.candidate_lines": "候補の行数",
  "apply_preview.changed_lines": "変更行数",
  "apply_preview.no_changes": "生成候補は現在のサーバー設定と一致しています。適用は任意です。",
  "apply_preview.no_current": "現在のサーバー設定ファイルが見つかりませんでした。初回の適用時に生成候補を書き込みます。",
  "apply_preview.refresh": "プレビューを更新",
  "apply_preview.refreshing": "更新中...",
  "network.title": "ネットワークマップ",
  "network.subtitle": "現在の Group -> User -> Peer 構成を確認できます。",
  "network.scene": "相関グラフ",
  "network.groups": "グループ",
  "network.users": "ユーザー",
  ...
  "network.filter_online": "オンラインのみ",
  "network.filter_active": "有効のみ",
  "network.filter_hidden": "未表示のみ",
  "network.mode_status": "状態モード",
  "network.mode_traffic": "トラフィックモード",
  ...
  "network.action_hint": "選択中ノードの有効 / 無効を切り替えます。",
  "network.focus_none": "ノードを選ぶと詳細を表示します。",
  "network.focus_none_hint": "グループ、ユーザー、ピアごとの関係と状態を確認できます。",
  "network.focus_summary": "フォーカス概要",
  "network.hotspots": "トラフィック上位ピア",
  "network.enable_selected": "有効化",
  "network.disable_selected": "無効化",
  "network.updating": "更新中...",
  "network.toggle_enabled": "有効化しました。",
  "network.toggle_disabled": "無効化しました。",
  ...
  "settings.login_user_role": "権限",
  "settings.login_user_role_admin": "管理者",
  "settings.login_user_role_group_admin": "グループ管理者",
  "settings.reset_password": "パスワード再設定",
  "settings.reset_password_description": "現在のパスワードを要求せず、このログインユーザーのパスワードを再設定します。",
  ...
  "settings.login_user_update_failed": "ログインユーザーの更新に失敗しました。",
  ...
  "settings.login_user_group_placeholder": "グループを選択",
